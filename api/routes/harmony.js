...
router.get('/complementary',(req, res, next) => {
    getColorHarmonyResponse(req,res,colorCalculator.calculateComplementary);
});

router.get('/splitComplementary',(req, res, next) => {
    getColorHarmonyResponse(req,res,colorCalculator.calculateSplitComplementary);
});

router.get('/triadic',(req, res, next) => {
    getColorHarmonyResponse(req,res,colorCalculator.calculateTriadic);
});

router.get('/tetradic',(req, res, next) => {
