const validator = {
    ...
    INVALID_H_COMPONENT: "h component must be between 0 and 360",
    INVALID_SL_COMPONENTS: "s and l components must be between 0 and 100",
    INVALID_SV_COMPONENTS: "s and v components must be between 0 and 100",
