...
let colorCalculator = {
    ...
    darken : (color, percentage,source) => {
        rgb = "rgb("+color.value[0]+","+color.value[1]+","+color.value[2]+")";
        console.log(percentage);
        const responseRGB = colorCalculator.pSBC(percentage * -1,rgb, false, true); 
        if(responseRGB){
            ...
            if(rgbComponents) {
                ...
                throw "error getting darken value"
            }
        }
    },
